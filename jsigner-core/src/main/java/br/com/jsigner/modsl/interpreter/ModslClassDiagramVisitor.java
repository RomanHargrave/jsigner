...
public class ModslClassDiagramVisitor implements ClassDiagramVisitor {
	...
	public void visit(ClassDiagram classDiagram) {
		...
		ModslClazzVisitor clazzVisitor = new ModslClazzVisitor();
		for (Clazz clazz : diagramClasses) {
			clazz.accept(clazzVisitor);
		}
		diagramCode.append(clazzVisitor.getResult());
